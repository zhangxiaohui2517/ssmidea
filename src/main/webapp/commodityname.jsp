            ...
            <div class="right-cont-wrap">
                <div class="right-cont">
                    ...
                    <div class="pager">
                        ...
                        ${page.pageNow} 页</font> <a href="selectgoodbyname.do?pageNow=1&title=${title}">首页</a>
                        <c:choose>
                            <c:when test="${page.pageNow - 1 > 0}">
                                <a href="selectgoodbyname.do?pageNow=${page.pageNow - 1}&title=${title}">上一页</a>
                            </c:when>
                            <c:when test="${page.pageNow - 1 <= 0}">
                                <a href="selectgoodbyname.do?pageNow=1&title=${title}">上一页</a>
                            </c:when>
                        </c:choose>
                        <c:choose>
                            <c:when test="${page.totalPageCount==0}">
                                <a href="selectgoodbyname.do?pageNow=${page.pageNow}&title=${title}">下一页</a>
                            </c:when>
                            <c:when test="${page.pageNow + 1 < page.totalPageCount}">
                                <a href="selectgoodbyname.do?pageNow=${page.pageNow + 1}&title=${title}">下一页</a>
                            </c:when>
                            <c:when test="${page.pageNow + 1 >= page.totalPageCount}">
                                <a href="selectgoodbyname.do?pageNow=${page.totalPageCount}&title=${title}">下一页</a>
                            </c:when>
                        </c:choose>
                        <c:choose>
                            <c:when test="${page.totalPageCount==0}&title=${title}">
                                <a href="selectgoodbyname.do?pageNow=${page.pageNow}&title=${title}">尾页</a>
                            </c:when>
                            <c:otherwise>
                                <a href="selectgoodbyname.do?pageNow=${page.totalPageCount}&title=${title}">尾页</a>
                            </c:otherwise>
                        </c:choose>
                    </div>
